...
public class HoroDeYahooComLoader {
	...
	String tag = "HoroDeYahooComLoader";
	
	int delayForThread;

	String[] months = {"januar", "februar", "m%C3%A4rz", "april", "mai", "juni", "juli", "august", "september", "october", "november", "dezember"};
	
	public HoroDeYahooComLoader (Context context, WebView[] webViews, RelativeLayout[] errorLayout, RelativeLayout[] allNormalLayout, ProgressBar[] progressBar ){
	        ...
	        public void run() {
	        	try {							//загрузка сегондя
					...
					resultS[1]="<span style=\"color: rgb(255, 69, 0);\"><span style=\"font-size: 18pt;\"><span style=\"font-size: 14pt;\"><span style=\"font-size: 16pt;\">"+
							...
							+"</span></span></span></p>";
					horoscopes[1]=context.getResources().getStringArray(R.array.de_yahoo_com_horoscopes)[1]+" : #"+context.getResources().getStringArray(R.array.zodiac_signs)[zodiacNumber-1]+"\n\n"+doc.getElementById("tab-date").text()+"\n"+doc.getElementsByClass("astro-tab-body").first().text();
					setResult(1);
	        ...
	        public void run() {
	        	try {							//загрузка сегондя
					...
					resultS[0]="<span style=\"color: rgb(255, 69, 0);\"><span style=\"font-size: 18pt;\"><span style=\"font-size: 14pt;\"><span style=\"font-size: 16pt;\">"+
							...
							doc.getElementsByClass("astro-tab-body").first().text()		//horo
							+"</span></span></span></p>";
					horoscopes[0]=context.getResources().getStringArray(R.array.de_yahoo_com_horoscopes)[0]+" : #"+context.getResources().getStringArray(R.array.zodiac_signs)[zodiacNumber-1]+"\n\n"+doc.getElementById("tab-date").text()+"\n"+doc.getElementsByClass("astro-tab-body").first().text();
					setResult(0);
				} catch (NotFoundException e) {
					Log.e(tag, "data Error");
					// TODO Auto-generated catch block
		...
		Thread thr=new Thread(new Runnable() {				//делаем в новом потоке
	        public void run() {
	        	try {							//загрузка сегондя
					Thread.sleep(delayForThread); 
					Calendar c = Calendar.getInstance();
					Document doc = Jsoup.connect("http://de.horoskop.yahoo.com/horoskop/"+context.getResources().getStringArray(R.array.nameOfzodiacForLoadDeYahooCom)[zodiacNumber-1].replace("*", "%C3%B6").replace("+", "%C3%BC")+"/astro"+context.getResources().getStringArray(R.array.nameOfHoroscopecForLoadDeYahooCom)[1]+monthPlusZero(String.valueOf(c.get(Calendar.WEEK_OF_YEAR)))+".html").userAgent(context.getResources().getString(R.string.user_agent)).timeout(context.getResources().getInteger(R.integer.user_timeout)).get();
					...
					resultS[2]="<span style=\"color: rgb(255, 69, 0);\"><span style=\"font-size: 18pt;\"><span style=\"font-size: 14pt;\"><span style=\"font-size: 16pt;\">"+
							...
							doc.getElementsByClass("astro-tab-body").first().text()		//horo
							+"</span></span></span></p>";
					horoscopes[2]=context.getResources().getStringArray(R.array.de_yahoo_com_horoscopes)[2]+" : #"+context.getResources().getStringArray(R.array.zodiac_signs)[zodiacNumber-1]+"\n\n"+doc.getElementById("tab-date").text()+"\n"+doc.getElementsByClass("astro-tab-body").first().text();
					setResult(2);
				} catch (NotFoundException e) {
					Log.e(tag, "data Error");
					// TODO Auto-generated catch block
		...
		Thread thr=new Thread(new Runnable() {				//делаем в новом потоке
	        public void run() {
	        	try {							//загрузка сегондя
					Thread.sleep(delayForThread); 
					Calendar c = Calendar.getInstance();
					Document doc = Jsoup.connect("http://de.horoskop.yahoo.com/horoskop/"+context.getResources().getStringArray(R.array.nameOfzodiacForLoadDeYahooCom)[zodiacNumber-1].replace("*", "%C3%B6").replace("+", "%C3%BC")+"/astro"+context.getResources().getStringArray(R.array.nameOfHoroscopecForLoadDeYahooCom)[2]+months[c.get(Calendar.MONTH)]+".html").userAgent(context.getResources().getString(R.string.user_agent)).timeout(context.getResources().getInteger(R.integer.user_timeout)).get();
					...
					resultS[3]="<span style=\"color: rgb(255, 69, 0);\"><span style=\"font-size: 18pt;\"><span style=\"font-size: 14pt;\"><span style=\"font-size: 16pt;\">"+
							...
							doc.getElementsByClass("astro-tab-body").first().text()		//horo
							+"</span></span></span></p>";
					horoscopes[3]=context.getResources().getStringArray(R.array.de_yahoo_com_horoscopes)[3]+" : #"+context.getResources().getStringArray(R.array.zodiac_signs)[zodiacNumber-1]+"\n\n"+doc.getElementById("tab-date").text()+"\n"+doc.getElementsByClass("astro-tab-body").first().text();
					setResult(3);
				} catch (NotFoundException e) {
					Log.e(tag, "data Error");
					// TODO Auto-generated catch block
		...
		Thread thr=new Thread(new Runnable() {				//делаем в новом потоке
	        public void run() {
	        	try {							//загрузка сегондя
					Thread.sleep(delayForThread); 
					Calendar c = Calendar.getInstance();
					Document doc = Jsoup.connect("http://de.horoskop.yahoo.com/horoskop/"+context.getResources().getStringArray(R.array.nameOfzodiacForLoadDeYahooCom)[zodiacNumber-1].replace("*", "%C3%B6").replace("+", "%C3%BC")+"/astro"+context.getResources().getStringArray(R.array.nameOfHoroscopecForLoadDeYahooCom)[3]+String.valueOf(c.get(Calendar.YEAR))+".html").userAgent(context.getResources().getString(R.string.user_agent)).timeout(context.getResources().getInteger(R.integer.user_timeout)).get();
					...
					resultS[4]="<span style=\"color: rgb(255, 69, 0);\"><span style=\"font-size: 18pt;\"><span style=\"font-size: 14pt;\"><span style=\"font-size: 16pt;\">"+
							...
							doc.getElementsByClass("astro-tab-body").first().text()		//horo
							+"</span></span></span></p>";
					horoscopes[4]=context.getResources().getStringArray(R.array.de_yahoo_com_horoscopes)[4]+" : #"+context.getResources().getStringArray(R.array.zodiac_signs)[zodiacNumber-1]+"\n\n"+String.valueOf(c.get(Calendar.YEAR))+"\n"+doc.getElementsByClass("astro-tab-body").first().text();
					setResult(4);
				} catch (NotFoundException e) {
					Log.e(tag, "data Error");
					// TODO Auto-generated catch block
