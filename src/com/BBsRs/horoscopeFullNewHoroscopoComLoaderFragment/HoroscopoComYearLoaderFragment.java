...
package com.BBsRs.horoscopeFullNewHoroscopoComLoaderFragment;
...
public class HoroscopoComYearLoaderFragment extends BaseFragment {
    ...
    //LOG_TAG for log
    String LOG_TAG = "Horoscopo.com"+UNIVERSAL_ID;
    	...
    	switch (item.getItemId()) {
	      ...
	      case R.id.menu_share_new:
	    	  ...
	    	  String shareBody = getResources().getString(R.string.share_content_horo_for)
					  +" "+getResources().getStringArray(R.array.horoscopo_com_horoscopes)[UNIVERSAL_ID].toLowerCase()
	        			...
	        			+"\n"
	        			+String.valueOf(textContent.getText()).replaceAll(getResources().getString(R.string.horoscopo_com_copyright), "")
			...
			new AsyncTask<Void, Void, Void>() {
                ...
                protected Void doInBackground(Void... params) {
                    try {
                    	...
                    	data = "2016"+"<br /><br />"+doc.getElementById("textline").html()+"<br /><br />"+getResources().getString(R.string.horoscopo_com_copyright)+"<br /><br /><br /><br />";
