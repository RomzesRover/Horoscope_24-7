...
public class HoroscopoComPersonalLoaderFragment extends BaseFragment {
    	...
    	switch (item.getItemId()) {
	      ...
	      case R.id.menu_share_new:
	    	  if (error || data.length()<10)
	    		  break;
			  String shareBody = getResources().getStringArray(R.array.horoscopo_com_horoscopes)[UNIVERSAL_ID]
