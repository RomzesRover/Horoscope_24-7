...
public class TarotComYesterdayLoaderFragment extends BaseFragment {
			...
			new AsyncTask<Void, Void, Void>() {
                ...
                protected Void doInBackground(Void... params) {
                    try {
                        ...
                        //load and retrieve data from tarot.com http://www.tarot.com/daily-horoscope/taurus/2014-12-24
                    	Document doc = Jsoup.connect("http://www.tarot.com/"+getResources().getStringArray(R.array.nameOfHoroscopecForLoadTarotCom)[UNIVERSAL_ID]+"/"+getResources().getStringArray(R.array.nameOfzodiacForLoadTarotCom)[Integer.parseInt(sPref.getString("preference_zodiac_sign", "0"))]+"/"+String.valueOf(c.get(Calendar.YEAR))+"-"+monthPlusZero(String.valueOf(c.get(Calendar.MONTH)+1))+"-"+monthPlusZero(String.valueOf(c.get(Calendar.DAY_OF_MONTH)))).userAgent(getResources().getString(R.string.user_agent)).timeout(getResources().getInteger(R.integer.user_timeout)).get();
                    	data = doc.getElementsByClass("js-today_interp_header_h3").first().text()+"<br /><br />"+doc.getElementsByClass("js-today_interp_copy").first().text()+"<br /><br />"+getResources().getString(R.string.copyright_tarot_com);
                    	if (!(doc.getElementsByClass("js-today_interp_copy").first().text().length()<10))
                    		error=false;
