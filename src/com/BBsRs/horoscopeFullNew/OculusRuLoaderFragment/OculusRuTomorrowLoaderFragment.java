...
public class OculusRuTomorrowLoaderFragment extends BaseFragment {
			...
			new AsyncTask<Void, Void, Void>() {
                ...
                protected Void doInBackground(Void... params) {
                    try {
                        ...
                        //load and retrieve data from oculus.ru http://www.oculus.ru/goroskop_na_segodnya/oven.html
                    	Document doc = Jsoup.connect("http://oculus.ru/"+getActivity().getResources().getStringArray(R.array.nameOfHoroscopecForLoadOculusRu)[UNIVERSAL_ID]+"/"+getActivity().getResources().getStringArray(R.array.nameOfzodiacForLoadOculusRu)[Integer.parseInt(sPref.getString("preference_zodiac_sign", "0"))]+".html").userAgent(getResources().getString(R.string.user_agent)).timeout(getResources().getInteger(R.integer.user_timeout)).get();
                    	data = doc.getElementsByClass("centerTitleBox").first().child(1).text()+"<br /><br />"+doc.getElementsByClass("oculus-epz-text").first().text().replaceFirst(getActivity().getResources().getStringArray(R.array.oculus_ru_zodiac_signs_ru)[Integer.parseInt(sPref.getString("preference_zodiac_sign", "0"))], "").replaceFirst(getActivity().getResources().getStringArray(R.array.oculus_ru_zodiac_signs_ru)[Integer.parseInt(sPref.getString("preference_zodiac_sign", "0"))], "")+"<br /><br />"+getResources().getString(R.string.copyright_oculus_ru); 
                    	if (!(doc.getElementsByClass("oculus-epz-text").first().text().replaceFirst(getActivity().getResources().getStringArray(R.array.oculus_ru_zodiac_signs_ru)[Integer.parseInt(sPref.getString("preference_zodiac_sign", "0"))], "").replaceFirst(getActivity().getResources().getStringArray(R.array.oculus_ru_zodiac_signs_ru)[Integer.parseInt(sPref.getString("preference_zodiac_sign", "0"))], "").length()<10))
                    		error=false;
