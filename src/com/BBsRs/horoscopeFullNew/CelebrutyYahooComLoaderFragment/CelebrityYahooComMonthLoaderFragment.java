...
package com.BBsRs.horoscopeFullNew.CelebrutyYahooComLoaderFragment;
...
public class CelebrityYahooComMonthLoaderFragment extends BaseFragment {
    ...
    //LOG_TAG for log
    String LOG_TAG = "celebrity.yahoo.com"+UNIVERSAL_ID;
    ...
    public void onResume() {
        ...
        getSupportActionBar().setSubtitle(getResources().getStringArray(R.array.zodiac_signs)[Integer.parseInt(sPref.getString("preference_zodiac_sign", "0"))]+" - "+getResources().getStringArray(R.array.celebrity_yahoo_com_horoscopes)[UNIVERSAL_ID]);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if (!error && data.length()>10)
        	...
        	actionProvider.setShareIntent(createShareIntent(
        			...
        			+" "+getResources().getStringArray(R.array.celebrity_yahoo_com_horoscopes)[UNIVERSAL_ID].toLowerCase()
			...
			new AsyncTask<Void, Void, Void>() {
                ...
                protected Void doInBackground(Void... params) {
                    try {
                    	...
                    	Document doc = Jsoup.connect("https://celebrity.yahoo.com/horoscope/"+getResources().getStringArray(R.array.nameOfzodiacForLoadCelebrityYahooCom)[Integer.parseInt(sPref.getString("preference_zodiac_sign", "0"))]+getResources().getStringArray(R.array.nameOfHoroscopecForLoadCelebrityYahooCom)[UNIVERSAL_ID]+getResources().getStringArray(R.array.nameOfmonthsForLoadCelebrityYahooCom)[c.get(Calendar.MONTH)]+".html").userAgent(getResources().getString(R.string.user_agent)).timeout(getResources().getInteger(R.integer.user_timeout)).get();
                    	data = doc.getElementsByClass("date").first().text()+"<br /><br />"+doc.getElementsByClass("desc").first().html()+"<br /><br />"+getResources().getString(R.string.copyright_celebrity_yahoo_com);
