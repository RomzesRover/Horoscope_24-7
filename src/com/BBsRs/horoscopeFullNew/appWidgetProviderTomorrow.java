...
public class appWidgetProviderTomorrow extends AppWidgetProvider {
	...
	public void onUpdate(final Context context, final AppWidgetManager appWidgetManager, final int[] appWidgetIds){
        ...
        if (zodiacNumber!=13)
        remoteViews.setTextViewText(R.id.sign, context.getResources().getStringArray(R.array.zodiac_signs)[zodiacNumber-1]+" - "+context.getResources().getString(R.string.tommorow));		//����� ����
