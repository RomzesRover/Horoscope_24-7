...
public class MailRuTodayLoaderFragment extends Fragment {
    ...
    public void onResume() {
        ...
        getSupportActionBar().setSubtitle(getResources().getStringArray(R.array.zodiac_signs)[Integer.parseInt(sPref.getString("preference_zodiac_sign", "0"))]+" - "+getResources().getStringArray(R.array.mail_ru_horoscopes)[1]);
        
        //check if settings changed
        if (sPref.getBoolean("changed_1", false)){
        	mPullToRefreshLayout.setRefreshing(true);
        	customOnRefreshListener.onRefreshStarted(null);
        	Editor ed = sPref.edit();   
			ed.putBoolean("changed_1", false);	
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if (!error && data.length()>10)
        	...
        	actionProvider.setShareIntent(createShareIntent(
        			...
        			+" "+getResources().getStringArray(R.array.mail_ru_horoscopes)[1].toLowerCase()
