...
public class MailRuPersonalLoaderFragment extends BaseFragment {
    	...
    	switch (item.getItemId()) {
	      ...
	      case R.id.menu_share_new:
	    	  if (error || data.length()<10)
	    		  break;
			  String shareBody = getResources().getStringArray(R.array.mail_ru_horoscopes)[UNIVERSAL_ID]
					  	+" "+getResources().getString(R.string.share_personal_1)
	        			+"\n"
	        			+String.valueOf(textContent.getText()).replaceAll(getResources().getString(R.string.mail_ru_copyright), "")
			...
			new AsyncTask<Void, Void, Void>() {
                ...
                protected Void doInBackground(Void... params) {
                    try {
                    	...
                    	data = "Прогноз на "+c.get(Calendar.DAY_OF_MONTH)+" "+getActivity().getResources().getStringArray(R.array.moths_of_year)[c.get(Calendar.MONTH)]+"<br /><br />"+doc.getElementsByClass("article__text").first().html()+"<br />"+getResources().getString(R.string.mail_ru_copyright)+"<br /><br /><br /><br />";
