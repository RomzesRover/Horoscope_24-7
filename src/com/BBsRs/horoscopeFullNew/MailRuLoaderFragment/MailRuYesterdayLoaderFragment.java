...
public class MailRuYesterdayLoaderFragment extends BaseFragment {
    ...
    public void onResume() {
        ...
        setTitle(getResources().getStringArray(R.array.zodiac_signs)[Integer.parseInt(sPref.getString("preference_zodiac_sign", "0"))]+";"+getResources().getStringArray(R.array.mail_ru_horoscopes)[UNIVERSAL_ID]);
			...
			new AsyncTask<Void, Void, Void>() {
                ...
                protected Void doInBackground(Void... params) {
                    try {
                    	...
                    	dateLenght = Html.fromHtml(doc.getElementsByClass("p-prediction__subtitle").first().html()).length()+1;
