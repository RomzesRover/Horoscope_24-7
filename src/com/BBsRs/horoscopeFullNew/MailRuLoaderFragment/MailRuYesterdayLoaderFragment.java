			...
			new AsyncTask<Void, Void, Void>() {
                ...
                protected Void doInBackground(Void... params) {
                    try {
                    	...
                    	data = doc.getElementsByClass("p-prediction__subtitle").first().html()+"<br /><br />"+doc.getElementsByClass("article__text").first().html()+"<br />"+getResources().getString(R.string.mail_ru_copyright)+"<br /><br /><br /><br />";
