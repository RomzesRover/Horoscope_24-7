...
public class HoroscopeComMoneyLoaderFragment extends BaseFragment {
    ...
    public void onResume() {
        ...
        SpannableString sb = new SpannableString(getResources().getStringArray(R.array.horoscope_com_horoscopes)[UNIVERSAL_ID]);
			...
			new AsyncTask<Void, Void, Void>() {
                ...
                protected Void doInBackground(Void... params) {
                    try {
                    	...
                    	data = doc.getElementsByClass("col420").get(0).child(2).text().replaceAll("Share with friends:","")+"<br /><br />"+doc.getElementsByClass("fontdef1").get(0).text()+"<br /><br />";
