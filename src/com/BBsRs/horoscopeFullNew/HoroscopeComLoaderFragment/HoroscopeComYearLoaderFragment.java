...
public class HoroscopeComYearLoaderFragment extends BaseFragment {
			...
			new AsyncTask<Void, Void, Void>() {
                ...
                protected Void doInBackground(Void... params) {
                    try {
                    	...
                    	data = "2017"+"<br /><br />"+doc.getElementById("personal").child(1).html()+"<br /><br />"+getResources().getString(R.string.horoscope_com_copyright)+"<br />";
                    	dateLenght = Html.fromHtml("2017").length()+1;
                    	if (!(doc.getElementById("personal").child(1).html().length()<10))
                    		error=false;
