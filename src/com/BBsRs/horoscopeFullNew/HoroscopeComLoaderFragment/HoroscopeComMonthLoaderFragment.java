...
public class HoroscopeComMonthLoaderFragment extends BaseFragment {
			...
			new AsyncTask<Void, Void, Void>() {
                ...
                protected Void doInBackground(Void... params) {
                    try {
                    	...
                    	data = doc.getElementsByClass("col420").get(0).child(0).child(8).text().replaceAll("Share with friends:","")+"<br /><br />"+doc.getElementsByClass("fontdef1").get(0).text()+"<br /><br />"+getResources().getString(R.string.copyright_horoscope_com);
