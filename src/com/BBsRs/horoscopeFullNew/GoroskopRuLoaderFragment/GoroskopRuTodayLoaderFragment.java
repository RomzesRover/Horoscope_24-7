...
//        			+" "+getResources().getStringArray(R.array.goroskop_ru_horoscopes)[1].toLowerCase()
			...
			new AsyncTask<Void, Void, Void>() {
                ...
                protected Void doInBackground(Void... params) {
                    try {
                    	...
                    	data = doc.getElementById("article").child(1).html()+doc.getElementById("article").child(2).html()+"<br />"+getResources().getString(R.string.copyright_goroskop_ru);
