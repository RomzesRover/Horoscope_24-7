			...
			new AsyncTask<Void, Void, Void>() {
                ...
                protected Void doInBackground(Void... params) {
                    try {
                    	...
                    	data = String.valueOf(c.get(Calendar.YEAR))+"<br /><br />"+doc.getElementsByClass("astro-tab-body").first().text()+"<br /><br />"+getResources().getString(R.string.copyright_de_horoskop_yahoo_com);
