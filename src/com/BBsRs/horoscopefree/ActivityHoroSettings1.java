...
public class ActivityHoroSettings1 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		final TextView txt = (TextView)findViewById(R.id.TextView01);
	    									//���� ����� ������ ��� ����. ������ ��� ����� � ������� ����� ������
		loadData(edName, edDateBirth, edTimeBirth,txt);				//��������� ������, ���� ��� ���� :)
	    ...
	    step2.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
		        ...
		        ed.putString("name", String.valueOf(edName.getText()));  		//���
			    ed.putInt("dayBorn", edDateBirth.getDayOfMonth());				//����
			    ed.putInt("monthBorn", edDateBirth.getMonth());				//�����
			    ed.putInt("yearBorn", edDateBirth.getYear());					//���
			    ed.putInt("minuteBorn", edTimeBirth.getCurrentMinute()); 		//������
			    ed.putInt("hourBorn", edTimeBirth.getCurrentHour());			//����
			    																//���� �� ��� � ������
			    ed.putInt("zodiacNumber", zodiacNumber(edDateBirth.getDayOfMonth(),edDateBirth.getMonth()+1));						//����, �� ������
