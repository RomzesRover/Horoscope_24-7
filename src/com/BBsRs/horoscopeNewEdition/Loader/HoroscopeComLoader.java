	...
	public ArrayList<HoroscopeCollection> loadCurrList(){
		try {
			...
			case Constants.BUNDLE_LIST_TYPE_YESTERDAY:
	    		...
	    		horoscopeCollection.add(new HoroscopeCollection(context.getResources().getStringArray(R.array.horoscope_com_kinds)[0], doc.getElementsByClass("tablet-ad").get(0).child(0).child(1).html(), "<a href=\""+doc.location()+"\">"+context.getResources().getString(R.string.horoscope_com_copyright)+"</a>"));
	    		...
	    		horoscopeCollection.add(new HoroscopeCollection(context.getResources().getStringArray(R.array.horoscope_com_kinds)[1], doc.getElementsByClass("tablet-ad").get(0).child(0).child(1).html(), "<a href=\""+doc.location()+"\">"+context.getResources().getString(R.string.horoscope_com_copyright)+"</a>"));
	    		...
	    		horoscopeCollection.add(new HoroscopeCollection(context.getResources().getStringArray(R.array.horoscope_com_kinds)[2], doc.getElementsByClass("tablet-ad").get(0).child(0).child(1).html(), "<a href=\""+doc.location()+"\">"+context.getResources().getString(R.string.horoscope_com_copyright)+"</a>"));
	    		...
	    		horoscopeCollection.add(new HoroscopeCollection(context.getResources().getStringArray(R.array.horoscope_com_kinds)[4], doc.getElementsByClass("tablet-ad").get(0).child(0).child(1).html(), "<a href=\""+doc.location()+"\">"+context.getResources().getString(R.string.horoscope_com_copyright)+"</a>"));
	    		...
	    		horoscopeCollection.add(new HoroscopeCollection(context.getResources().getStringArray(R.array.horoscope_com_kinds)[6] + " - " + sPref.getInt(Constants.PREFERENCES_PERSONAL_NUMBER, 3), doc.getElementsByClass("tablet-ad").get(0).child(0).child(1).html(), "<a href=\""+doc.location()+"\">"+context.getResources().getString(R.string.horoscope_com_copyright)+"</a>"));
				break;
			...
			case Constants.BUNDLE_LIST_TYPE_WEEKLY:
	    		...
	    		horoscopeCollection.add(new HoroscopeCollection(context.getResources().getStringArray(R.array.horoscope_com_kinds)[1] + " single", doc.getElementsByClass("tablet-ad").get(0).child(0).child(2).html(), "<a href=\""+doc.location()+"\">"+context.getResources().getString(R.string.horoscope_com_copyright)+"</a>"));
	    		doc = Jsoup.connect("https://www.horoscope.com/us/horoscopes/love/horoscope-love-weekly-couple.aspx?sign="+(sPref.getInt(Constants.PREFERENCES_ZODIAC_SIGN, 0)+1)).userAgent(context.getResources().getString(R.string.user_agent)).timeout(context.getResources().getInteger(R.integer.user_timeout)).proxy(proxy).get(); if (cancelLoad) return null;
	    		horoscopeCollection.add(new HoroscopeCollection(context.getResources().getStringArray(R.array.horoscope_com_kinds)[1] + " couple", doc.getElementsByClass("tablet-ad").get(0).child(0).child(2).html(), "<a href=\""+doc.location()+"\">"+context.getResources().getString(R.string.horoscope_com_copyright)+"</a>"));
	    		...
	    		horoscopeCollection.add(new HoroscopeCollection(context.getResources().getStringArray(R.array.horoscope_com_kinds)[3], doc.getElementsByClass("tablet-ad").get(0).child(0).child(1).html(), "<a href=\""+doc.location()+"\">"+context.getResources().getString(R.string.horoscope_com_copyright)+"</a>"));
			...
			case Constants.BUNDLE_LIST_TYPE_YEARLY:
				...
				try {
					doc = Jsoup.connect("https://www.horoscope.com/us/horoscopes/yearly/2020-horoscope-"+context.getResources().getStringArray(R.array.horoscope_com_yearly_zodiac_signs)[sPref.getInt(Constants.PREFERENCES_ZODIAC_SIGN, 0)]+".aspx?type=personal").proxy(proxy).get();
		    		horoscopeCollection.add(new HoroscopeCollection(doc.getElementById("personal").child(0).html(), "<strong>"+"2020 year"+"</strong> - " + doc.getElementById("personal").child(1).html(), "<a href=\""+doc.location()+"\">"+context.getResources().getString(R.string.horoscope_com_copyright)+"</a>")); if (cancelLoad) return null;
		    		doc = Jsoup.connect("https://www.horoscope.com/us/horoscopes/yearly/2020-horoscope-"+context.getResources().getStringArray(R.array.horoscope_com_yearly_zodiac_signs)[sPref.getInt(Constants.PREFERENCES_ZODIAC_SIGN, 0)]+".aspx?type=career").proxy(proxy).get();
		    		horoscopeCollection.add(new HoroscopeCollection(doc.getElementById("career").child(0).html(), "<strong>"+"2020 year"+"</strong> - " + doc.getElementById("career").child(1).html(), "<a href=\""+doc.location()+"\">"+context.getResources().getString(R.string.horoscope_com_copyright)+"</a>")); if (cancelLoad) return null;
		    		doc = Jsoup.connect("https://www.horoscope.com/us/horoscopes/yearly/2020-horoscope-"+context.getResources().getStringArray(R.array.horoscope_com_yearly_zodiac_signs)[sPref.getInt(Constants.PREFERENCES_ZODIAC_SIGN, 0)]+".aspx?type=love_single").proxy(proxy).get();
		    		horoscopeCollection.add(new HoroscopeCollection(doc.getElementById("singles").child(0).html(), "<strong>"+"2020 year"+"</strong> - " + doc.getElementById("singles").child(1).html(), "<a href=\""+doc.location()+"\">"+context.getResources().getString(R.string.horoscope_com_copyright)+"</a>")); if (cancelLoad) return null;
		    		doc = Jsoup.connect("https://www.horoscope.com/us/horoscopes/yearly/2020-horoscope-"+context.getResources().getStringArray(R.array.horoscope_com_yearly_zodiac_signs)[sPref.getInt(Constants.PREFERENCES_ZODIAC_SIGN, 0)]+".aspx?type=love_couples").proxy(proxy).get();
		    		horoscopeCollection.add(new HoroscopeCollection(doc.getElementById("couples").child(0).html(), "<strong>"+"2020 year"+"</strong> - " + doc.getElementById("couples").child(1).html(), "<a href=\""+doc.location()+"\">"+context.getResources().getString(R.string.horoscope_com_copyright)+"</a>")); if (cancelLoad) return null;
		    		if (cal.get(Calendar.YEAR) == 2019)
			...
			case Constants.BUNDLE_LIST_TYPE_YEARLY_CHINA:
				...
				try {
					doc = Jsoup.connect("https://www.horoscope.com/us/horoscopes/yearly/2020-chinese-horoscope-"+context.getResources().getStringArray(R.array.horoscope_com_yearly_zodiac_signs_chinese)[sPref.getInt(Constants.PREFERENCES_CHINESE_SIGN, 0)]+".aspx").proxy(proxy).get();
		    		horoscopeCollection.add(new HoroscopeCollection(doc.getElementById("overview").child(0).html() + " - " + context.getResources().getStringArray(R.array.chinese_zodiac_signs)[sPref.getInt(Constants.PREFERENCES_CHINESE_SIGN, 1)], "<strong>"+"2020 year"+"</strong> - " + doc.getElementById("overview").child(1).html(), "<a href=\""+doc.location()+"\">"+context.getResources().getString(R.string.horoscope_com_copyright)+"</a>")); if (cancelLoad) return null;
		    		horoscopeCollection.add(new HoroscopeCollection(doc.getElementById("love").child(0).html() + " - " + context.getResources().getStringArray(R.array.chinese_zodiac_signs)[sPref.getInt(Constants.PREFERENCES_CHINESE_SIGN, 1)], "<strong>"+"2020 year"+"</strong> - " + doc.getElementById("love").child(1).html(), "<a href=\""+doc.location()+"\">"+context.getResources().getString(R.string.horoscope_com_copyright)+"</a>")); if (cancelLoad) return null;
		    		horoscopeCollection.add(new HoroscopeCollection(doc.getElementById("family").child(0).html() + " - " + context.getResources().getStringArray(R.array.chinese_zodiac_signs)[sPref.getInt(Constants.PREFERENCES_CHINESE_SIGN, 1)], "<strong>"+"2020 year"+"</strong> - " + doc.getElementById("family").child(1).html(), "<a href=\""+doc.location()+"\">"+context.getResources().getString(R.string.horoscope_com_copyright)+"</a>")); if (cancelLoad) return null;
		    		horoscopeCollection.add(new HoroscopeCollection(doc.getElementById("work").child(0).html() + " - " + context.getResources().getStringArray(R.array.chinese_zodiac_signs)[sPref.getInt(Constants.PREFERENCES_CHINESE_SIGN, 1)], "<strong>"+"2020 year"+"</strong> - " + doc.getElementById("work").child(1).html(), "<a href=\""+doc.location()+"\">"+context.getResources().getString(R.string.horoscope_com_copyright)+"</a>")); if (cancelLoad) return null;
		    		horoscopeCollection.add(new HoroscopeCollection(doc.getElementById("money").child(0).html() + " - " + context.getResources().getStringArray(R.array.chinese_zodiac_signs)[sPref.getInt(Constants.PREFERENCES_CHINESE_SIGN, 1)], "<strong>"+"2020 year"+"</strong> - " + doc.getElementById("money").child(1).html(), "<a href=\""+doc.location()+"\">"+context.getResources().getString(R.string.horoscope_com_copyright)+"</a>")); if (cancelLoad) return null;
		    		if (cal.get(Calendar.YEAR) == 2019)
			    		handler.post(new Runnable(){
							@Override
							public void run() {
