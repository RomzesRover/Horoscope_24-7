	...
	public ArrayList<HoroscopeCollection> loadCurrList(){
		try {
			...
			case Constants.BUNDLE_LIST_TYPE_YESTERDAY:
				...
				horoscopeCollection.add(new HoroscopeCollection(context.getResources().getStringArray(R.array.mail_ru_kinds)[0] + " - " + doc.getElementsByClass("p-prediction__right").first().child(1).child(0).text().replaceFirst("Прогноз на ", ""), res));
            	doc = Jsoup.connect("https://horo.mail.ru/numerology/calc/31/?v1="+String.valueOf(sPref.getInt(Constants.PREFERENCES_YEAR_BORN, cal.get(Calendar.YEAR)-20))+"-"+intPlusZero(sPref.getInt(Constants.PREFERENCES_MONTH_BORN, cal.get(Calendar.MONTH))+1)+"-"+String.valueOf(sPref.getInt(Constants.PREFERENCES_DAY_BORN, cal.get(Calendar.DAY_OF_MONTH)))+"&v2="+String.valueOf(cal.get(Calendar.YEAR))+"-"+intPlusZero(cal.get(Calendar.MONTH)+1)+"-"+String.valueOf(cal.get(Calendar.DAY_OF_MONTH)))
				...
				if (res.substring(res.length()-12).equals("<br /><br />"))
					res = res.substring(0, res.length()-12); 
            	horoscopeCollection.add(new HoroscopeCollection(context.getResources().getStringArray(R.array.mail_ru_kinds)[1] + " - " + cal.get(Calendar.DAY_OF_MONTH)+" "+context.getResources().getStringArray(R.array.moths_of_year)[cal.get(Calendar.MONTH)]+"<br />" + String.valueOf(sPref.getInt(Constants.PREFERENCES_DAY_BORN, cal.get(Calendar.DAY_OF_MONTH)))+"."+intPlusZero(sPref.getInt(Constants.PREFERENCES_MONTH_BORN, cal.get(Calendar.MONTH))+1)+"."+String.valueOf(sPref.getInt(Constants.PREFERENCES_YEAR_BORN, cal.get(Calendar.YEAR)-20)), res));
				break;
			...
			case Constants.BUNDLE_LIST_TYPE_MONTHLY:
				...
				if (res.substring(res.length()-12).equals("<br /><br />"))
					res = res.substring(0, res.length()-12);    
            	horoscopeCollection.add(new HoroscopeCollection(context.getResources().getStringArray(R.array.mail_ru_kinds)[1] + " - " + context.getResources().getStringArray(R.array.moth_of_year)[cal.get(Calendar.MONTH)]+" "+String.valueOf(cal.get(Calendar.YEAR))+" года <br />" + String.valueOf(sPref.getInt(Constants.PREFERENCES_DAY_BORN, cal.get(Calendar.DAY_OF_MONTH)))+"."+intPlusZero(sPref.getInt(Constants.PREFERENCES_MONTH_BORN, cal.get(Calendar.MONTH))+1)+"."+String.valueOf(sPref.getInt(Constants.PREFERENCES_YEAR_BORN, cal.get(Calendar.YEAR)-20)), res));
				break;
			case Constants.BUNDLE_LIST_TYPE_YEARLY:
				...
				if (res.substring(res.length()-12).equals("<br /><br />"))
					res = res.substring(0, res.length()-12);    
            	horoscopeCollection.add(new HoroscopeCollection(context.getResources().getStringArray(R.array.mail_ru_kinds)[1] + " - " +String.valueOf(cal.get(Calendar.YEAR))+" год <br />" + String.valueOf(sPref.getInt(Constants.PREFERENCES_DAY_BORN, cal.get(Calendar.DAY_OF_MONTH)))+"."+intPlusZero(sPref.getInt(Constants.PREFERENCES_MONTH_BORN, cal.get(Calendar.MONTH))+1)+"."+String.valueOf(sPref.getInt(Constants.PREFERENCES_YEAR_BORN, cal.get(Calendar.YEAR)-20)), res));
				break;
			}
